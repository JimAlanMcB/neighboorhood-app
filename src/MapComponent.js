        ...
        <InfoWindow
          ...
          visible={this.props.showingInfoWindow}>
            <div className="infowindow">
              ...
              {this.props.showingInfoWindow ? this.props.selectedPlace.reviews.map(review => <h4>{review}</h4>): <h4>{this.props.selectedPlace.reviews}</h4>}
              <a href={this.props.selectedPlace.url}></a>
            </div>
